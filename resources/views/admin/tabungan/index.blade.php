...
<h1>Data <strong>Tabungan Masuk</strong></h1>
        ...
        @endphp
          @foreach ($data as $item)
            <tr>
                ...
                @can('isAdmin')
                <td>
                  <a href="{{ route('tabungan.delete',$item->id) }}" class="btn btn-danger" onclick="return confirm('Yakin Anda Ingin Menghapus?')"><i class="bi bi-trash"></i></a>
                </td>
                @elsecan('isTeller')
