...
@section('content')
    <div class="container">
        <h2 class="mt-3">Halaman Galeri Sekolah</h2>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                           @foreach ($data as $item)
                            <tr>
                                <td>{{ $item->judul }}</td>
                                <td><img src="{{ asset('/storage/images/'.$item->gambar) }}" width="10%"></td>
                                <td><a href="{{ route('galeri.delete', $item->id) }}" class="btn btn-danger">Delete</a></td>
                            </tr>
                           @endforeach
                        </tbody>
                    </table>
