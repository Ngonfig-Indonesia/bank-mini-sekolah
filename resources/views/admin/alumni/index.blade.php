...
@section('content')
    <div class="container">
        <h2 class="mt-3">Data <strong>Alumni</strong></h2>
                           ...
                           @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('alumni.delete', $item->id)}}" class="btn btn-danger" onclick="return confirm('Yakin Anda Ingin Menghapus?')"><i class="bi bi-trash"></i></a>
                                </td>                                
                            </tr>
                           @endforeach
                        </tbody>
        ...
        <div class="modal-content">
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                    <form action="{{ route('alumni.create') }}" method="post" enctype="multipart/form-data">
                        @csrf
